...
在 `main.js` 中通过插件方式引入 AileUI 时，可对全局的 `AileInput` 配置如下属性：
...
支持 `element-ui` 中的 [Input文档板块](https://element.eleme.io/#/zh-CN/component/input) 的所有使用方式。

:::demo
```html
<div class="demo-input">
  <aile-input v-model="input" placeholder="请输入内容"></aile-input>
</div>
...
```html
<div class="demo-input">
  <aile-input placeholder="请输入密码" v-model="input" show-password></aile-input>
</div>
...
<div class="demo-input">
  <div>
    <aile-input placeholder="请输入内容" v-model="input1">
      <template slot="prepend">Http://</template>
    </aile-input>
  </div>
  <div style="margin-top: 15px;">
    <aile-input placeholder="请输入内容" v-model="input2">
      <template slot="append">.com</template>
    </aile-input>
  </div>
  <div style="margin-top: 15px;">
    <aile-input placeholder="请输入内容" v-model="input3" class="input-with-select">
...
<style>
  .el-select .aile-input {
    width: 130px;
  }
  .input-with-select .aile-input-group__prepend {
